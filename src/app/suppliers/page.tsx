/**
 * Страница списка поставщиков — /suppliers
 *
 * Показывает карточки всех поставщиков с информацией:
 * - Название и статус (Работает / Обслуживание / Недоступен)
 * - Регион и тип подключения (API или парсинг)
